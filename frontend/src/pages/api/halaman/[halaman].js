...
export default async function handler(req, res) {
  switch (req.method) {
    case "GET":
      console.log(req.query.artikel, 'check')
      if (req.query.halaman === 'all') {
...
const Getdata = async (req, res) => {
  try {
    const sqlQuery = 'SELECT id_pages as id, title, DATE_FORMAT(created_at,"%Y-%M-%d") as created_at,DATE_FORMAT(updated_at,"%Y-%M-%d") as updated_at, user_id, titleen, content, contenten,seotitle, tags, picture, active FROM pages order by id_pages desc';
