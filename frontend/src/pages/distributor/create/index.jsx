...
const Index = props => {
  ...
  return (
    <>
      <Headtitle title={'Tambah Distrobutor'} />
      <Card>
        <Header>
          <Typography variant='h5'>
            <Icon icon='tabler:edit' />
            Tambah Distributor</Typography>
          <IconButton
            size='small'
            onClick={handleClose}
            sx={{
                  ...
                  <Controller
                    ...
                    render={({ field: { value, onChange } }) => (
                      <CustomTextField
                        ...
                        error={Boolean(errors.nama_distributor)}
                        {...(errors.title && { helperText: errors.nama_distributor.message })}
                      />
                    )}
                  />
                </Grid>
                  ...
                  <Controller
                    ...
                    render={({ field: { value, onChange } }) => (
                      <CustomTextField
                        ...
                        {...(errors.fax && { helperText: errors.fax.message })}
                      />
                    )}
                  />
                </Grid>
