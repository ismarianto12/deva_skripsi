...
export const Create = async (req, res) => {
  ...
  try {
    await db.query(`INSERT INTO jenis_barang set jenis_barang =?`, {
      replacements: [
        jenis_barang
      ],
...
export const DetailData = async (req, res) => {
  const { jenis_barang } = req.body
  try {
    await db.query(`Select jenis_barang where jenis_barang =?`, {
      replacements: [
        jenis_barang
      ],
      type: Sequelize.INSERT,
...
export { Edit, Update, Delete, Show, ListArtikel, ListJenis }
